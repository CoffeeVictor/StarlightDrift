...
void Wave1()
{
    fscanf (inimigo[0], "%f %f\n",&foe[0].posicao.x,&foe[0].posicao.y);
    fscanf (inimigo[1], "%f %f\n",&foe[1].posicao.x,&foe[1].posicao.y);
    fscanf (inimigo[2], "%f %f\n",&foe[2].posicao.x,&foe[2].posicao.y);
    fscanf (inimigo[3], "%f %f\n",&foe[3].posicao.x,&foe[3].posicao.y);
    fscanf (inimigo[4], "%f %f\n",&foe[4].posicao.x,&foe[4].posicao.y);
    fscanf (inimigo[5], "%f %f\n",&foe[5].posicao.x,&foe[5].posicao.y);
